class RubrosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @rubro.save
        format.html { redirect_to @rubro, notice: 'Rubro guardado correctamente.' }
  ...
  def update
    respond_to do |format|
      if @rubro.update(rubro_params)
        format.html { redirect_to @rubro, notice: 'Rubro actualizado correctamente.' }
  ...
  def destroy
    @rubro.destroy
    respond_to do |format|
      format.html { redirect_to rubros_url, notice: 'Rubro eliminado correctamente.' }
