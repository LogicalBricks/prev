...
class DepositosControllerTest < ActionController::TestCase
  ...
  test "should create deposito" do
    assert_difference('Deposito.count') do
      post :create, params: {
        deposito: { descripcion: @deposito.descripcion, fecha: @deposito.fecha, monto: @deposito.monto, prevision_id: @deposito.prevision_id }
      }
    end
    ...
    assert_difference('Deposito.count') do
      post :create, params: {
        deposito: {
          ...
          prevision_id: @deposito.prevision_id,
          pago_de_comisiones_o_impuestos: true,
          comision_ids: [comision.id]
        }
      }
    end
    ...
    assert_difference('Deposito.count', 0) do
      post :create, params: {
        deposito: {
          ...
          monto: @deposito.monto,
          prevision_id: @deposito.prevision_id,
          pago_de_comisiones_o_impuestos: false,
          gasto_ids: [gasto.id]
        }
      }
    end
  ...
  test "should show deposito" do
    get :show, params: { id: @deposito }
    assert_response :success
  end

  test "should get edit" do
    get :edit, params: { id: @deposito }
    assert_response :success
  end

  test "should update deposito" do
    patch :update, params: {
      id: @deposito, deposito: { descripcion: @deposito.descripcion, fecha: @deposito.fecha, monto: @deposito.monto, prevision_id: @deposito.prevision_id }
    }
    assert_redirected_to deposito_path(assigns(:deposito))
  end
  ...
  test "should destroy deposito" do
    assert_difference('Deposito.count', -1) do
      delete :destroy, params: { id: @deposito }
    end
